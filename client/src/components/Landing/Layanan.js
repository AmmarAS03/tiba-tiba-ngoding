            ...
            <div class="flex flex-col w-full lg:w-[947px] justify-between items-center lg:gap-0 gap-4 lg:flex-row">
                <div class="flex flex-col items-center justify-center w-[300px] h-[185px] py-[10px] px-[20px] gap-[10px] flex-shrink-0 rounded-[10px] border-[0.3px] border-black bg-[#FFF] shadow-md">
                    ...
                    <div class="flex flex-row gap-1 justify-center self-stretch text-center font-poppins text-[12px] font-semibold leading-[140%]">
                        ...
                        <div class="text-[#71825E]">
                            Kegiatan
                        </div>
                    </div>
                    <div class="h-[58px] flex-shrink-0 self-stretch text-black text-justify font-poppins text-[10px] font-normal leading-[140%]">
                        We are committed to protecting our planet for future generations. Sustainability is at the forefront of
                        our environmental initiatives, from cleanups to conservation efforts.
                    </div>
                </div>
                <div class="flex flex-col items-center justify-center w-[300px] h-[185px] py-[10px] px-[20px] gap-[10px] flex-shrink-0 rounded-[10px] border-[0.3px] border-black bg-[#FFF] shadow-md">
                    <img src="assets/Kegiatan.png" alt="Your Image" class="w-[47px] h-[47px] flex-shrink-0" />
                    <div class="flex flex-row gap-1 justify-center self-stretch text-center font-poppins text-[12px] font-semibold leading-[140%]">
                        <div class="text-black">
                            Laporkan
                        </div>
                    ...
                    <div class="h-[58px] flex-shrink-0 self-stretch text-black text-justify font-poppins text-[10px] font-normal leading-[140%]">
                        We cherish the sense of belonging and unity within our community. Together, we are more than the sum of
                        our parts, and we value the relationships and connections that make us strong.
                    </div>
                </div>
                <div class="flex flex-col items-center justify-center w-[300px] h-[185px] py-[10px] px-[20px] gap-[10px] flex-shrink-0 rounded-[10px] border-[0.3px] border-black bg-[#FFF] shadow-md">
                    <img src="assets/Point.png" alt="Your Image" class="w-[47px] h-[47px] flex-shrink-0" />
                    <div class="flex flex-row gap-1 justify-center self-stretch text-center font-poppins text-[12px] font-semibold leading-[140%]">
                        <div class="text-black">
                            Raih
                        </div>
                    ...
                    <div class="h-[58px] flex-shrink-0 self-stretch text-black text-justify font-poppins text-[10px] font-normal leading-[140%]">
                        We embody it in everything we do. Compassion is our guiding light, inspiring us to take action and make

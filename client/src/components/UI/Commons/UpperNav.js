...
function UpperNav() {
    ...
    return (
        <>
            <div class='fixed flex flex-wrap top-0 w-screen h-auto px-[37.5px] py-[18.75px] justify-between items-center border-[0.844px] border-[#71825E] bg-white' style={{ zIndex: 1000 }}>
